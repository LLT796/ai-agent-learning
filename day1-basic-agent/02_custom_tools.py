...
PRODUCT_DB = {
    ...
    "机械键盘": {
        ...
        "stock": 42,
        "rating": 4.8,
        "features": ["Gasket 结构", "三模热插拔", "PBT 键帽", "RGB 背光"],
    },
    "运动手表": {
        ...
        "stock": 67,
        "rating": 4.7,
        "features": ["高尔夫球场地图", "自由潜水模式", "ECG 心电分析", "14天续航"],
    },
    "双肩背包": {
        "name": "Samsonite 新秀丽 商务双肩包",
        "price": 459,
        "original_price": 699,
        "category": "背包",
        "stock": 312,
        "rating": 4.4,
        "features": ["15.6寸电脑仓", "防泼水面料", "USB 充电口", "减压背带"],
    },
}
...
if __name__ == "__main__":
    ...
    # 场景 6: 新商品 —— 计算折扣力度
    print("\n>>> 场景 6: 新商品折扣计算")
    chat("那个双肩背包现在便宜了多少钱？折扣力度大吗？")

    # 场景 7: 跨品类搜索 —— 预算内推荐
    print("\n>>> 场景 7: 跨品类预算推荐")
    chat("我有500块预算，能买到什么好东西？")

    # 场景 8: 多步复杂任务 —— 搜索 + 对比 + 计算
    print("\n>>> 场景 8: 复杂多步推理")
    chat("帮我看看运动手表和机械键盘，哪个折扣更大？买便宜那个能省多少钱？")